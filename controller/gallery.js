...
router.get('/getItem/top/:num', function(req, res, next) {
    res.send({
        ...
        data: [{
                ...
                'mode': 'single',
                img: [
                    { src: '1_0.jpg', animation: { delay: '0.3s', opacity: {} } },
                    { src: '1_1.png', animation: { delay: '0.3s', opacity: {} } }
                ]
            },
            {
                id: 2,
                ...
                'mode': 'multi',
                img: [
                    { src: '2_0.jpg', animation: { delay: '0.3s', opacity: {} } },
                    { src: '2_1.png', animation: { delay: '0.3s', opacity: {} } }
                ]
            },
