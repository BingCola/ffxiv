...
export default class Page extends Base {
    ...
    get MODEL_TEMPLATE() {
        return `
            ...
            <div class="divCharacter c-clear-fix">
                <div class="wrapCharacterTarget">
                    <div class="wrapChoose selected c-check-wrap" data-user="author">
                        <span class="c-check-icon"></span><span class="c-check-text">模特为上传者</span></span>
                    </div>
                    <div class="wrapChoose c-check-wrap" data-user="select">
                    ...
                    <div class="wrapChoose c-check-wrap" data-user="custom">
                        <span class="c-check-icon"></span><span class="c-check-text">自定义模特</span></span>
                    </div>
                </div>
                <div class="info">
                    <div class="divField c-input-wrap" data-field="name">
    ...
    initModel() {
        ...
        $btnAdd.off('click').on('click', e => {
            $wrap.append(this.createConsistDom());
        });
        $wrap.on('click', '.btnConsistDel ', e => {
            $(e.currentTarget)
                .parent()
                .remove();
        });
        $wrap.on('click', '.toolItem ', e => {
            $(e.currentTarget)
                .siblings()
