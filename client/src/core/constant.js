export default {
    ...
    CHARACTER: {
        RACE: {
            1: { text: '人类' },
            2: { text: '高地之民', parent: 1 },
            3: { text: '中原之民', parent: 1 },
            4: { text: '猫魅' },
            5: { text: '护月之民', parent: 4 },
            6: { text: '逐日之民', parent: 4 },
            7: { text: '精灵' },
            8: { text: '森林之民', parent: 7 },
            9: { text: '黑影之民', parent: 7 },
            10: { text: '拉拉菲尔' },
            11: { text: '平原之民', parent: 10 },
            12: { text: '沙漠之民', parent: 10 },
            13: { text: '鲁加' },
            14: { text: '北洋之民', parent: 13 },
            15: { text: '红焰之民', parent: 13 },
            16: { text: '奥拉' },
            17: { text: '晨曦之民', parent: 16 },
            18: { text: '暮辉之民', parent: 16 }
        },
        JOB: {
            1: { text: '坦克职业', val: 1 },
