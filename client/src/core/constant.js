export default {
    ...
    CHARACTER: {
        ...
        JOB: {
            ...
            23: { text: '园艺师', val: 23, parent: 21 },
            24: { text: '捕鱼人', val: 24, parent: 21 },
            25: { text: '能工巧匠', val: 25 },
            26: { text: '刻木', val: 26, parent: 25 },
            27: { text: '锻铁', val: 27, parent: 25 },
            28: { text: '铸甲', val: 28, parent: 25 },
            29: { text: '雕金', val: 29, parent: 25 },
            30: { text: '裁缝', val: 30, parent: 25 },
            31: { text: '制革', val: 31, parent: 25 },
            32: { text: '烹饪', val: 32, parent: 25 },
            33: { text: '炼金', val: 33, parent: 25 }
        },
        GENDER: {
            1: { text: '男性', val: 1 },
            2: { text: '女性', val: 2 }
