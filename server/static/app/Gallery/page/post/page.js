        ...
        class Page {
            ...
            initConsistInfo() {
                ...
                $wrap.on('click', '.wrapUserSelect .divSelectItem', function(e) {
                    ...
                    $infoCtn[0].innerHTML = '\
                <img class="portrait" src="' + AppConfig.path.image + '/user/' + target.dataset.id + '.png"/>\
                ...
                <span class="color itemInfo">不可染色</span>';
                        ...
                        $infoCtn.parent().parent().prev().prev()[0].src = AppConfig.path.image + '/user/' + target.dataset.id + '.png';
                    })
